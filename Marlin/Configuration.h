...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS              24 + 14 // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
  ...
  #define NEOPIXEL_BKGD_INDEX_LAST    23 + 14 // Index of the last background LED
